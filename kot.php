...
<br>
       <div class="container">
       	...
       	<h2 class="h4">KITCHEN ORDER TICKETS</h2>
...
<div class="row">
    ...
    <table id="" class="table table-hover">
			...
			<tbody>
				<?php 
$selectSalesCat = $mysqli->query("SELECT kot_id,kot_number,kot_datetime,item_name,item_qty,table_number FROM kot,tables WHERE tables_ID = tableS.table_id") or die("ERROR 5000");
					while($data = $selectSalesCat->fetch_assoc()):
				 ?>
				<tr>
					<td><?php echo $data['kot_number'];?></td>
					<td><?php echo $data['item_name'];?></td>
					<td><?php echo $data['item_qty'];?></td>
					<td><?php echo $data['table_number'];?></td>
					<td><?php
                    $time =  $data['kot_datetime'];
                     echo date('Y M d H:i:s A',$time);
                     
                     ?></td>
                     <td><a href="includes/delete.kot.php?delete=<?php echo $data['kot_id']; ?>" class="btn btn-danger">X</a></td>
